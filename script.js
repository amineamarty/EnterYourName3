...
document.forms[0].onsubmit = (e)=>{
    e.preventDefault();
    if(myinput.value === "khawla"||myinput.value === "Khala"||myinput.value === "Khwla"||myinput.value === "Khla"||myinput.value === "Rim"||myinput.value === "rime"||myinput.value === "Rimee"||myinput.value === "Rime"||myinput.value === "Khawla"){
